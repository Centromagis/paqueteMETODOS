...
conceptos importantes en el análisis descriptivo de datos
...
El resumen de datos para variables cualitativas se centra en la construcción de tablas de frecuencia. Dependiendo si la variable es medida en escala nominal u ordinal la tabla presenta o no las frecuencias acumuladas
...
Estas tabla son de utilidad cuando se requiere el análisis bivariado de dos variables cualitativas. Se denominan también tablas de doble entrada debido a las columnas representan los niveles de una variable, mientras que las filas representan los niveles de la segunda variable.
...
quiz(
  question("La suma de las frecuencias relativas correspondientes a todos los valores de una variable es:", 
           ...
           answer("100", message = "Cerca, pero no,...inténtalo de nuevo!"),
           answer("n, tamaño de la muestra", message = "Incorrecto. Intenta de nuevo!."),
           answer("Ninguna de las anteriores" , message = "Incorrecto...inténtalo de nuevo!"),
...
quiz(
  question("¿No podemos afirmar de acuerdo con la anterior información, que:", 
           ...
           allow_retry = TRUE,
           answer("Un poco más de la mitad se alimenta saludablemente", message = "No...inténtalo de nuevo!"),
           answer("El 51% de los encuestados se alimenta saludablemente y realiza actividad deportiva", message = "No...inténtalo de nuevo!"),
...
quiz(
  question("De la anterior información podemos afirmar que: ", 
           ...
           answer("Los participantes en la categoría Abierta conforman el 70% del grupo", message = "No...inténtalo de nuevo!"),
           answer("La media de la variable es 1179", message = "Incorrecto. Intenta de nuevo!."),
           answer("El dato atípico lo constituye la categoría Juvenil con 19 participantes", message = "No...inténtalo de nuevo!"),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
quiz(
  question("Cuando se requiere construir una tabla de frecuencias a partir de una variables cualititativa en escala nominal, se deben incluir: ", 
           ...
           allow_retry = TRUE,
           answer("Las frecuencias absolutas y las frecuencias absolutas acumuladas ", message = "No,...inténtalo de nuevo!"),
           ...
           answer("Solo las frecuencias relativas", message = "No...inténtalo de nuevo!"),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
quiz(
  question("Para el caso de las variables cualitativas es necesario agrupar los valores en intervalos siguiendo los siguientes criterios :", 
           ...
           allow_retry = TRUE,
           answer("Siempre debe tomar intervalos de igual longitud", message = "No, pero...inténtalo de nuevo!"),
           answer("En todos los casos la función de R hace el proceso mediante la regla de Sturges", message = "No...inténtalo de nuevo!"),
           answer("Es necesario analizar el contexto para tomar una decisión, es decir depende si el resultado se compara con resultados anteriores o si existe una clasificacion natural de la variable", correct = TRUE),
...
Construya una tabla que permita  el análisis de la variable categoría por sexo
...
Las categóricas están delimitadas por rango de edades así
