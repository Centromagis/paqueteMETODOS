...
allow_retry = TRUE,
answer("El 50% de los valores al rededor de la media", message = "Cerca, pero no...inténtalo de nuevo!"),
answer("Todos los valores, menos los valores atípicos", message = "Nop...inténtalo de nuevo!"),
...
allow_retry = TRUE,
answer("Un diagrama circular o diagrama de tortas", message = "No,...inténtalo de nuevo!"),
answer("Un diagrana de dispersión", message = "No...inténtalo de nuevo!"),
...
allow_retry = TRUE,
answer("El tiempo de duración de una llamada", message = "No...inténtalo de nuevo!"),
answer("El peso de un paquete", message = "No...inténtalo de nuevo!"),
...
allow_retry = TRUE,
answer("La mediana de los tiempos es 161", message = "No...inténtalo de nuevo!"),
answer("La media es 186", message = "No...inténtalo de nuevo!"),
...
allow_retry = TRUE,
answer("Este diagráma permite visualizar el rango de tiempo con mayor concentración", message = "Cerca, pero no...inténtalo de nuevo!"),
...
answer("La forma de la gráfica es simétrica con algunos datos atípicos" , message = "Nop...inténtalo de nuevo!"),
# Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
submit_button = "Enviar respuesta",
try_again_button = "Intentar de nuevo"),
# Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
El paquete  `paqueteMETODOS` contiene la data inflación que corresponde a la serie de tiempo de este indicador desde enero de 1993 a diciembre de 2022. Construya una gráfica de tiempo que de cuenta del comportamiento de esta variable para el periodo indicado.
...
Durante 5 meses se construyen 134 kilómetros de carretera en la siguiente forma: En el primer mes, 3.60% del total del proyecto; en el segundo mes un 7.60% del total; en el tercer mes, el 15.3% del total; en el cuarto mes 24.5% del total y en último mes, el 49% restante.
