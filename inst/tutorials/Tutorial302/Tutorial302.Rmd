...
| intervalos de confianza $\beta_0$,$\beta_1$ | `confint(modelo1)`                                |
| ANOVA                          | `anova(modelo1)`                                               |
...
| test de especificación - Prueba RESET | `resettest(y~x, power=2, type="regressor")`             |
| test de  White - varianza constante   | `modelo1=lm(residuos~x)`                                |
...
quiz(
  question("La ecuación resultante de la estimación es. ", 
           correct = "Correcto!.", 
           allow_retry = TRUE,
           answer("clientes = 19.9800 + 0.2606 ventas", message = "No...inténtalo de nuevo!"),
           answer("ventas = 19.9800 + 0.2606 clientes", correct = TRUE),    
           answer("ventas = 0.2606 clientes", message = "Incorrecto. Intenta de nuevo!."),
           answer("clientes = 4.3897 + 0.0420 ventas", message = "No...inténtalo de nuevo!"),
...
quiz(
  question("El modelo resultante de la estimación es:", 
           ...
           answer("ventas = 0.2606 clientes", message = "No...inténtalo de nuevo!"),
           answer("ventas = 19.9800 + 0.2606 clientes", message = "Incorrecto. Intenta de nuevo!."),
           answer("ventas =0.2606 + 19.9800 clientes", message = "No...inténtalo de nuevo!"),
           # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  # Si no ponemos un caption aparecerá la palabra Quiz en inglés.
...
quiz(
  question("Del método de estimación MCO  no es posible afirmar que :", 
           ...
           allow_retry = TRUE,
           answer("Las estimaciones de los parámetros son insesgadas", message = "Cerca, pero no...inténtalo de nuevo!"),
           answer("Las estimaciones son las mismas que se encuentran por el método de máxima verosimilitud", message = "Nop...inténtalo de nuevo!"),
...
quiz(
  question("El resultado indica que la mejor transformación de la variable respuesta es: ", 
           ...
           allow_retry = TRUE,
           answer("Inverso del cuadrado de Y", message = "Cerca, pero no...inténtalo de nuevo!"),
           answer("Inverso de la raiz cuadrada de  Y", message = "Nop...inténtalo de nuevo!"),
...
quiz(
  question("No es un supuesto del modelo de regresión lineal simple", 
           ...
           allow_retry = TRUE,
           answer("Valor esperado de los errores  igual a cero", message = "Cerca, pero no...inténtalo de nuevo!"),
           answer("Errores con distribución normal", message = "Nop...inténtalo de nuevo!"),
